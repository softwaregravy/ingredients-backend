...
RSpec.describe DrinksController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new drink" do

        post :create, params: {drink: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(drink_url(Drink.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new drink" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the drink" do
        drink = Drink.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the drink" do
        drink = Drink.create! valid_attributes
